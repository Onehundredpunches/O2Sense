...
export const AnatomicalSimulator: React.FC<AnatomicalSimulatorProps> = ({
  ...
  const labels: AnatomicalLabel[] = [
    ...
    },
    {
      id: 'tongue',
      name: 'Cơ cằm - lưỡi',
      role: 'Cơ cằm - lưỡi là cơ quan trọng giúp giữ đường thở vùng hầu mở. Khi ngủ, cách điều khiển thần kinh–cơ thay đổi; ở người có đường thở dễ xẹp, khả năng bù trừ có thể không đủ trong một số thời điểm.',
      x: 0.48,
      y: 0.46,
    },
    {
      id: 'obstruction',
      name: 'Vùng tắc nghẽn hầu họng',
    ...
    {
      id: 'brain',
      name: 'Vỏ não & Hệ lưới hoạt hóa',
      role: 'Tiếp nhận kích thích thiếu O₂/ứ CO₂; vi thức giấc vỏ não có thể xuất hiện nhưng không bắt buộc ở mọi sự kiện tái mở đường thở.',
      x: 0.62,
      y: 0.25,
    },
    {
      id: 'chemoreceptor',
      name: 'Thể cảnh (Thụ thể hóa học ngoại biên)',
